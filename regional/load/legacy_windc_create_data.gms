$title Create the WiNDC Legacy Regional dataset

$OnText
Create the Legacy Regional dataset with sets and parameters that match classic 
WiNDC notation.
...
Options:
    ...
    - `output` - Name of the output GDX file. Default is `regional_legacy_windc.gdx`.
