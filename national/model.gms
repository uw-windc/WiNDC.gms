...
ty(sec, yr) = ty_0(sec, yr);
ta(com, yr) = ta_0(com, yr);
tm(com, yr) = tm_0(com, yr);
...
$prod:A(com)$a_(com)  s:0  t:2 dm:2
    o:PA(com)   q: Armington_Supply(com, "2024")          a:ra    t:ta(com, "2024")   p:(1-ta_0(com, "2024"))
    o:PFX       q: Export(com, "2024")
    i:PY(com)   q: Gross_Output(com, "2024")         dm:
    i:PFX       q: Import(com, "2024")               dm:  a:ra    t:tm(com, "2024")   p:(1+tm_0(com, "2024"))
