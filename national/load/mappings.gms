...
set map_com(com, g) Mapping from NAICS to WiNDC labels /
    ...
    Used.use     ! Scrap, used and secondhand goods
/;
...
set xfd "Exogenous Final Demand Categories" /
    equipment        ! Nonresidential private fixed investment in equipment,
    intelprop        ! Nonresidential private fixed investment in intellectual property products,
    ...
    def_intelprop    ! Federal national defense: Gross investment in intellectual property products,
    ...
    fed_intelprop    ! Federal nondefense: Gross investment in intellectual property products,
    ...
    state_intelprop  ! State and local: Gross investment in intellectual property products,
...
set map_ifd(ifd, xfd) /
    F02E.equipment   ! Nonresidential private fixed investment in equipment 
    F02N.intelprop   ! Nonresidential private fixed investment in intellectual property products 
    F02R.residential ! Residential private fixed investment   
    F02S.structures  ! Nonresidential private fixed investment in structures  
    F030.changinv    ! Change in private inventories
/;

set map_gfd(gfd, xfd) /
    F06C.defense          ! National defense: Consumption expenditures    
    F06E.def_equipment    ! Federal national defense: Gross investment in equipment          
    F06N.def_intelprop    ! Federal national defense: Gross investment in intellectual property products          
    F06S.def_structures   ! Federal national defense: Gross investment in structures           
    F07C.nondefense       ! Nondefense: Consumption expenditures       
    F07E.fed_equipment    ! Federal nondefense: Gross investment in equipment          
    F07N.fed_intelprop    ! Federal nondefense: Gross investment in intellectual property products          
    F07S.fed_structures   ! Federal nondefense: Gross investment in structures           
    F10C.state_consume    ! State and local government consumption expenditures          
    F10E.state_equipment  ! State and local: Gross investment in equipment            
    F10N.state_intelprop  ! State and local: Gross investment in intellectual property products            
    F10S.state_invest     ! State and local: Gross investment in structures         
/;


set va "Value Added Categories" /
    compen     ! Compensation of employees
...
$OnText
 Correlate WiNDC labels with BEA NAICS codes. Preserve original set names. Note
 that in the national module of `windc_build` the sets `i` and `j` are aliases. 
 We relax that assumption so that `i` is commodities and `j` is sectors.
$OffText

set i "Commodities/Goods in WiNDC"    /
    agr      ! Farms
    fof      ! Forestry, fishing, and related activities
    oil      ! Oil and gas extraction
    min      ! Mining, except oil and gas
...
set map_com(com, i) Mapping from NAICS to WiNDC labels /
    111CA.agr    ! Farms
    113FF.fof    ! Forestry, fishing, and related activities
    211.oil      ! Oil and gas extraction
    212.min      ! Mining, except oil and gas
...
set map_sec(sec, j) Mapping from NAICS to WiNDC labels /
    111CA.agr    ! Farms
    113FF.fof    ! Forestry, fishing, and related activities
    211.oil      ! Oil and gas extraction
    212.min      ! Mining, except oil and gas
...
set fd "Exogenous Final Demand Categories" /
